...
function validateLogin(req, res, next) {
  ...
  */
  ...
  var _schema$validate = schema.validate(payload),
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            descodificado = _jsonwebtoken["default"].verify(token, _config["default"].SECRET); //console.log(descodificado)
          ...
          case 8:
            ...
            return _context.abrupt("return", res.statuus(404).json({
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 14:
            return _context2.abrupt("return", res.status(403).json({
              "ERROR": "Moderator Role is required "
            }));
          case 15:
          case "end":
